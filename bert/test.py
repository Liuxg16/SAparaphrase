...
from pytorch_pretrained_bert.modeling import SentenceBert, BertForPreTraining
...
def test():
    ...
    model = SentenceBert.from_pretrained(args.bert_model)
    model.to(device)
...
if __name__ == "__main__":
    test1()
    #sents = ['who do you like', 'who do you like most']
